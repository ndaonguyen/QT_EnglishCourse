...
public:
    ...
    void setupUi(QMainWindow *MyClassClass)
    {
        ...
        saveCourseButton->setGeometry(QRect(120, 520, 91, 23));
        ...
        step2Widget->setGeometry(QRect(70, 130, 381, 161));
        ...
        step3Widget->setGeometry(QRect(70, 320, 381, 241));
        ...
        line1_2->setGeometry(QRect(70, 110, 381, 16));
        ...
        line2_3->setGeometry(QRect(70, 300, 381, 16));
    ...
    void retranslateUi(QMainWindow *MyClassClass)
    {
        ...
        saveCourseButton->setText(QApplication::translate("MyClassClass", "Save Course", 0, QApplication::UnicodeUTF8));
